...
describe('features', () => {
  ...
  before(async () => {
    ...
    await masterNode.axeCore.getApi()
      .generate(1500);
    ...
    insightURL = `http://127.0.0.1:${masterNode.insightApi.options.getApiPort()}/insight-api-axe`;

    transactionIdSendToAddress = await masterNode.axeCore.getApi()
      .sendToAddress(faucetAddress, 100);
    await dapiClient.generate(20);
    const result = await masterNode.axeCore.getApi()
